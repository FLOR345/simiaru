...
// Servicio de notificaciones por email para SIMIARU usando Resend
...
// Email desde (Resend requiere verificar dominio, por ahora usa el de prueba)
const EMAIL_FROM = 'SimiAru <onboarding@resend.dev>';
